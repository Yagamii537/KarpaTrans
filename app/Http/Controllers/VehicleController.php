...
class VehicleController extends Controller
{
    ...
    {
        if ($vehicle->chassis()->exists()) {
            return back()->withErrors([
                'delete' => 'No se puede eliminar porque tiene chasis asociados.',
            ]);
        }
    ...
    private function validateVehicle(
        ...
        return $request->validate([
            ...
            'internal_code' => [
                ...
                'string',
                'max:50',
                Rule::unique('vehicles', 'internal_code')->ignore($vehicle?->id),
            ],
            ...
            'ownership_type' => [
                'required',
                Rule::in(['PROPIO', 'ALQUILADO', 'TERCERO']),
            ],
            'owner_name' => ['nullable', 'string', 'max:255'],
            'owner_identification' => ['nullable', 'string', 'max:20'],
    ...
    private function saveFiles(
        ...
        $fields = [
            'photo' => 'vehicles/photos',
            'registration_document' => 'vehicles/registrations',
            'insurance_document' => 'vehicles/insurance',
            'technical_review_document' => 'vehicles/reviews',
        ];
    ...
    private function deleteFiles(Vehicle $vehicle): void
    {
        foreach (
            [
                $vehicle->photo,
