...
class PlantController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('plants.create', compact('clients'));
    }
    ...
    public function edit(Plant $plant): View
    {
        $clients = Client::query()
            ->where('is_active', true)
            ->orWhere('id', $plant->client_id)
            ->orderBy('business_name')
            ->get();

        return view('plants.edit', compact('plant', 'clients'));
    }
    ...
    private function validatePlant(
        ...
        return $request->validate([
            ...
            'client_id.required' => 'Seleccione el cliente.',
            'client_id.exists' => 'El cliente seleccionado no existe.',
            'name.required' => 'El nombre de la planta es obligatorio.',
            'name.unique' => 'Este cliente ya tiene una planta con ese nombre.',
