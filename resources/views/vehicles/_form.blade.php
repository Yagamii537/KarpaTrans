    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="vehicle_type" class="form-select" required>
            @foreach([
                ...
                <option value="{{ $value }}"
                    @selected(old('vehicle_type', $vehicle->vehicle_type ?? 'TRACTOCAMION') === $value)>
                    {{ $label }}
                </option>
            @endforeach
        </select>
    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="operational_status" class="form-select" required>
            @foreach([
                ...
                <option value="{{ $value }}"
                    @selected(old('operational_status', $vehicle->operational_status ?? 'AVAILABLE') === $value)>
                    {{ $label }}
                </option>
            @endforeach
        </select>
    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="ownership_type" class="form-select">
            @foreach([
                ...
                <option value="{{ $value }}"
                    @selected(old('ownership_type', $vehicle->ownership_type ?? 'PROPIO') === $value)>
                    {{ $label }}
                </option>
            @endforeach
        </select>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="date"
               ...
               value="{{ old(
                   ...
                   isset($vehicle?->registration_expiration_date)
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="date"
               ...
               value="{{ old(
                   ...
                   isset($vehicle?->insurance_expiration_date)
                       ? $vehicle->insurance_expiration_date->format('Y-m-d')
                       : ''
               ) }}">
    </div>
