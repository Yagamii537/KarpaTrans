...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
    ...
    <div>
        <h4 class="fw-semibold mb-1">Vehículos</h4>
        <p class="text-muted mb-0">Administración de cabezales y vehículos.</p>
    </div>
        ...
        <form method="GET"
            ...
            <div class="col-md-5">
                <input type="text"
                       name="search"
                       class="form-control"
                       placeholder="Buscar placa, código, marca o modelo"
                       value="{{ $search }}">
            </div>
