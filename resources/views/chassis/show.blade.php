...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-semibold mb-1">{{ $chassis->display_name }}</h4>
        <p class="text-muted mb-0">Información completa del chasis.</p>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                @if ($chassis->photo)
                    <img src="{{ asset('storage/' . $chassis->photo) }}"
                         class="img-fluid rounded"
                         style="max-height:250px;">
                @else
                    <i class="ti ti-trailer text-primary"
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <small class="text-muted d-block">Vehículo habitual</small>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        {{ $chassis->maximum_capacity_tons
                            ? $chassis->maximum_capacity_tons . ' toneladas'
                            : 'No registrada' }}
                    </div>
